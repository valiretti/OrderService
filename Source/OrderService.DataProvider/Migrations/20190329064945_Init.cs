        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerRequests_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExecutorRequests_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Photos_Executors_ExecutorId",
                        column: x => x.ExecutorId,
                        principalTable: "Executors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerRequests_OrderId",
                table: "CustomerRequests",
                column: "OrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExecutorRequests_OrderId",
                table: "ExecutorRequests",
                column: "OrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_WorkTypeId",
                table: "Orders",
                column: "WorkTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Photos_ExecutorId",
                table: "Photos",
                column: "ExecutorId");
